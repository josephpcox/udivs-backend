...
def test_users_table():
    ...
    try:
        ...
        cursor.execute('CREATE TABLE IF NOT EXISTS users (user_id serial PRIMARY KEY,username VARCHAR (50) UNIQUE NOT NULL,password VARCHAR (50) NOT NULL,admin BOOLEAN NOT NULL DEFAULT FALSE,csv_file BYTEA)')
